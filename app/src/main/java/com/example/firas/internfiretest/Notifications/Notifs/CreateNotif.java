package com.example.firas.internfiretest.Notifications.Notifs;
...
public class CreateNotif extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        choix_dep.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(view.getContext(),text+" "+items_dep_id.get(choix_dep.getSelectedItemPosition()),Toast.LENGTH_LONG ).show();
        ...
        choix_classe.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(view.getContext(),text+" "+items_class_id.get(choix_classe.getSelectedItemPosition()),Toast.LENGTH_LONG ).show();
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getApplicationContext(), " "+dep_id+" "+classe_id+" "+is_prof+" msg: "+msg+" enm", Toast.LENGTH_LONG).show();

                Services s = new Services();
                s.CreateNotif(dep_id,classe_id,msg,getApplicationContext());
    ...
    public void GetDeps()
    {
        ...
        String url = host + "/api/myschool/departments/";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            ArrayAdapter<String> adapter = new ArrayAdapter<String>(CreateNotif.this,
