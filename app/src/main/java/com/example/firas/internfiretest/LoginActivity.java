...
import com.example.firas.internfiretest.Signup.SignupActivity;
...
public class LoginActivity extends AppCompatActivity {
    ...
    public void Login_fb(final String token) {
        ...
        StringRequest postRequest = new StringRequest(POST, url,
            ...
            protected Map<String,String> getParams(){
                Map<String,String> params = new HashMap<String, String>();
                params.put("client_id", "vl3Ik4xdnPEiXNJv29ptKRRV4vNRG5O3kHH2LZ4h");
                params.put("client_secret", "6zL2nxbWTaky839p8nc2IFd0FAwfFLv9OWD4qgnLyB0gU3Qe0SiA1IdKRCK0otHm6NDvvfcxTpZFt5dP8W01AblAoQb9E9fctNS4cerUmwWfR6MVCnUteWRXUUNMz3ts");
