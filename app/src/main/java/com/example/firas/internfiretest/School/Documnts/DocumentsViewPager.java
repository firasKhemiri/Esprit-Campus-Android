package com.example.firas.internfiretest.School.Documnts;
...
public class DocumentsViewPager extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   GetDepData(id);
        ...
        PagerAdapter pagerAdapter =
                new PagerAdapter(getSupportFragmentManager(), DocumentsViewPager.this);
...
class PagerAdapter extends FragmentPagerAdapter {
    ...
    String tabTitles[] = new String[]{"Autres Documents"};
    Context context;

    PagerAdapter(FragmentManager fm, DocumentsViewPager context) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        ...
        switch (position) {
            case 0:
                ...
                postargs.putString("url", "/api/school/"+id+"/docs");
